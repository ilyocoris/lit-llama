...
def prepare(
    #destination_path: Path = Path("checkpoints"),
    ...
    file_path = Path('/fs/startiger0/nmoghe/data/llama/pilot/classification/sqm/ref-free/train.json')

    # TODO: If we don't have the Meta weights, where do we get the tokenizer from?
    tokenizer = Tokenizer(tokenizer_path)
    
    with open('/fs/startiger0/nmoghe/data/llama/pilot/classification/sqm/ref-free/train-small.json', "r") as file:
        train_set = json.load(file)

    with open('/fs/startiger0/nmoghe/data/llama/pilot/classification/sqm/ref-free/dev.json', "r") as file:
        dev_set = json.load(file)


    with open('/fs/startiger0/nmoghe/data/llama/pilot/classification/sqm/ref-free/test.json', "r") as file:
    ...
    test_set = [prepare_sample(sample, tokenizer, max_seq_length, mask_inputs) for sample in tqdm(dev_set)]
    torch.save(dev_set, file_path.parent / "dev.pt")
